  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="text-center mb-6">
          ...
          <h2 className="text-2xl font-bold text-white">Hubungkan Instagram</h2>
      </div>
                  ...
                  {deviceType === 'desktop' && !isExtension && (
                    <div className="animate-fade-in text-left">
                        <p className="text-slate-300 mb-6 text-center max-w-lg mx-auto text-sm">
                            Untuk pengguna PC/Laptop, gunakan salah satu metode dibawah ini untuk mengambil data dengan aman tanpa password.
                        </p>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
                            ...
                            <div className="p-5 rounded-xl bg-slate-800/50 border border-slate-600 hover:border-slate-500 transition-colors group">
                                <div className="flex items-center gap-2 mb-3">
                                    ...
                                    <h3 className="font-bold text-white text-sm">Metode Bookmark (Paling Mudah)</h3>
                                </div>
                                <p className="text-xs text-slate-400 mb-4 h-8 leading-4">
                                    Seret tombol ungu dibawah ini ke <b>Bookmarks Bar</b> browser Anda.
                                </p>
                                <a 
                                    ref={bookmarkletRef}
                                    ...
                                    title="Seret saya ke bookmarks bar!"
                                >
                                    <span>🔖</span>
                            ...
                            <div className="p-5 rounded-xl bg-slate-800/50 border border-slate-600 hover:border-slate-500 transition-colors">
                                <div className="flex items-center gap-2 mb-3">
                                    ...
                                    <h3 className="font-bold text-white text-sm">Metode Console (Developer)</h3>
                                </div>
                                <p className="text-xs text-slate-400 mb-4 h-8 leading-4">
                                    Copy script, tekan <code className="bg-slate-900 px-1 rounded text-yellow-500 font-mono">F12</code> di tab Instagram, lalu Paste di Console.
                                </p>
                                <button 
                                    onClick={async () => {
                                        await copyScript();
                                ...
                                >
                                    {scriptCopied ? "✅ Script Tersalin!" : "📋 Copy Script"}
                                </button>
                                <p className="text-[10px] text-slate-500 mt-2 italic text-center">
                                    Paste script di Console (tab Network/Console) Instagram.
                                </p>
                            </div>
                        </div>

                        <div className="flex flex-col items-center">
                             <div className="text-xs text-slate-500 mb-2">Jika sudah menjalankan script di tab Instagram:</div>
                             <button
