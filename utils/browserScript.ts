...
(async () => {
  try {
      ...
      overlay.innerHTML = "<div><h3 id='ii-txt' style='margin:0 0 10px;font-size:18px;'>Loading... Please wait.</h3><div style='width:250px;height:6px;background:#333;border-radius:3px;overflow:hidden;margin:0 auto;'><div id='ii-bar' style='width:0%;height:100%;background:#8b5cf6;transition:width 0.3s;'></div></div></div><div id='ii-result' style='display:none;margin-top:30px;width:100%;max-width:320px;'><p style='font-size:14px;color:#cbd5e1;margin-bottom:15px;'>Scan Complete! Use the button below:</p><button id='ii-copy-btn' style='width:100%;padding:16px;background:#22c55e;color:#fff;border:none;border-radius:12px;font-size:16px;font-weight:bold;cursor:pointer;box-shadow:0 4px 12px rgba(34,197,94,0.4);margin-bottom:15px;display:flex;align-items:center;justify-content:center;gap:8px;'>COPY RESULTS</button><textarea id='ii-json' readonly style='width:100%;height:60px;background:#1e293b;border:1px solid #334155;color:#94a3b8;font-size:10px;border-radius:8px;padding:8px;margin-bottom:10px;'></textarea><button id='ii-close-btn' style='background:transparent;border:1px solid #475569;color:#94a3b8;padding:10px;border-radius:8px;width:100%;font-size:12px;'>Close</button></div>";
